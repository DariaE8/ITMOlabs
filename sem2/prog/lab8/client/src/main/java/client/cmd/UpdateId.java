...
public class UpdateId extends Command {
    ...
    private static final String USAGE = "Использование: update <ID> [данные] или update <ID> (интерактивный режим)";
    ...
    public UpdateId(Terminal terminal,ConnectionHandler chandler) {
        super("update", "обновить билет по указанному ID");
    ...
    public UpdateId(ConnectionHandler chandler) {
        super("update", "обновить билет по указанному ID");
        this.chandler = Objects.requireNonNull(chandler, "Обработчик запросов не может быть null");
    }
    ...
    public void execute(String[] args) throws CommandException {
        try {
            ...
            Response resp = chandler.request(new server_cmd.UpdateId(id, updatedTicket));
    ...
    public String execute_gui(long id, Ticket updatedTicket) throws CommandException {
        try {
            Response resp = chandler.request(new server_cmd.UpdateId(id, updatedTicket));
