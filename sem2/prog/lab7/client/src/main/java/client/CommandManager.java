...
public class CommandManager {
   ...
   */
  public void init(Terminal terminal, ConnectionHandler chandler, LoginManager loginManager) {
    ...
    Objects.requireNonNull(loginManager, "LoginManager не может быть null");
    // registerCommands(terminal);
    registerClientOnlyCommands(terminal);
    registerClientServerCommands(terminal, chandler);
    registerAuthCommands(terminal, chandler, loginManager);
  }
  ...
  public void executeCommand(String commandName, String[] args) throws CommandException {
    ...
    //   throw new CommandException("Ошибка: Пользователь не авторизован!");
    // }
  ...
  private void registerAuthCommands(Terminal terminal, ConnectionHandler chandler, LoginManager loginManager) {
    addCommand("sign_in", new SignIn(terminal, chandler, loginManager));
    addCommand("sign_up", new SignUp(terminal, chandler, loginManager));
    addCommand("sign_out", new SignOut(terminal, loginManager));
  } 
}
